...
| [21-history-expiry](21-history-expiry.md) | #21 | Written; not run yet. Installs a live daily trigger, `s21_daily`: remove it with `s21_removeTrigger` when the 7-day observation ends. |
