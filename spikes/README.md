...
| [29-part-encoding](29-part-encoding.md) | #29 | Run 2026-09-26 (scenarios 12 and 14 pending UI sends). Part data is a signed byte array, CTE undone, and Gmail transcodes every text part to UTF-8, so decode as UTF-8 and ignore the declared charset. Headers arrive RFC 2047-decoded. Fixtures in `test/fixtures/gmail/`. |
